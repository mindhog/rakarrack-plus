...
void DelayFileWindowGui::cb_add_button_i(RKR_Button*, void*) {
  dlyFileGroup *ADDG = new dlyFileGroup(30,60,540,30);
...
{ Delay_Group = new RKR_Group(0, 0, 605, 265);
  ...
  { Fl_Round_Button* o = new Fl_Round_Button(375, 22, 72, 25, "Apply");
    o->tooltip("Apply Changes to Echotron");
    o->type(0);
    o->box(FL_ROUND_UP_BOX);
    o->down_box(FL_ROUND_DOWN_BOX);
  } // Fl_Round_Button* o
  { add_button = new RKR_Button(471, 22, 25, 25, "+");
...
void DelayFileWindowGui::make_delay_window() {
  ...
  //      {
  	  dlyFileGroup *DG = new dlyFileGroup(30,0,540,30);      
  //      }
